...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    const updateAnimation = () => {
      ...
      updateCellOpacities();
      drawGrid();
      if (isCanvasVisible && isDocumentVisible && !prefersReducedMotion) {
    ...
    const handleMouseMove = event => {
      ...
      if (prefersReducedMotion || !isDocumentVisible || !isCanvasVisible) {
        updateCellOpacities();
        drawGrid();
      }
    };
  ...
  }, [backgroundColor, borderColor, direction, hoverFillColor, hoverTrailAmount, shape, speed, squareSize]);
