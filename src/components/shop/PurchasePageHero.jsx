...
const PurchasePageHero = ({ eyebrow, title, description, action }) => (
  <header className="mb-10 grid gap-6 border-b border-white/60 pb-8 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
    <div>
      <div className="mb-4 inline-flex rounded-full border border-artisan-primary-light/35 bg-white/65 px-3.5 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-artisan-primary shadow-sm backdrop-blur-sm">
        {eyebrow}
      </div>
